...
class Request(models.Model):
    ...
    is_request_for_others = models.BooleanField(verbose_name='Requesting for others (use below map to tell us their location) - മറ്റൊരാൾക്ക് വേണ്ടി അപേക്ഷിക്കുന്നു', default=False)
